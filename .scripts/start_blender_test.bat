...
"%blender_path%" -y -b -noaudio -P blenderkit_asset_tasks\.scripts\run_unittests_in_blender.py -- -s blenderkit_asset_tasks\.tests\unittests -p "test_*.py" --runner-stream none >> !current_dir!blender_test_results.txt 2>&1
if errorlevel 1 (
